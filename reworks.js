  ...
  if(this.song.id.includes("song")){
    ...
    switch(eval(action)) {
      ...
      default:
        ...
        this.song.pause();
        this.song.currentTime=0;
        /*  adding SC stop because SC not stopping when going from SC->Audio */
        // if(this.scPlayer != undefined){
...
// Create reusable function to determine song called in players
function setSong(list, song, n){
  setTimeout(function(){
  this.playlist=list;
  this.song=song;
  var newID=n;
...
Jukebox.prototype.back = function(){
  ...
  if (newID>=0){
    ...
    setSong(this.playlist, this.song, newID);
  }
}
